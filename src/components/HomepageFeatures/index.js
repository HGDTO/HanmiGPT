...
const FeatureList = [
  {
    title:(
      <a to= "/../../../docs/GPT/GPT-4/" target="_self" rel="noopener noreferrer">
      GPT-4
      </a>       
    ),  
  ...
  {
    title:(
      <a to= "/../../../docs/GPT/DocsGPT/" target="_self" rel="noopener noreferrer">
      Docs GPT
      </a>       
    ),  
  ...
  {
    title:(
      <a to= "/../../../docs/GPT/VoiceGPT/" target="_self" rel="noopener noreferrer">
      Voice GPT
      </a>       
    ),  
 ...
 //아래 설명 참조//
  ...
  {
    title:(
      <a to= "/../../../docs/GPT/Google/" target="_self" rel="noopener noreferrer">
      Google Search
      </a>       
    ),  
    Img: google,
